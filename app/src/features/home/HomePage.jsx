...
export default function HomePage({ onNavigateToWorkspace }) {
    ...
    <div style={{
      ...
      <section style={{ marginBottom: 48 }}>
        ...
        <div style={{ ...S.flex(12), marginBottom: 16 }}>
          ...
          {!showEmpty && (
            <button style={{ ...S.btnS, fontSize: 14, background: '#111', color: '#fff', border: '1px solid #111' }} onClick={onNavigateToWorkspace}>
              + New Workflow
            </button>
          )}
          ...
          {!showEmpty && (
            <button
              style={{ ...S.btnGhost, fontSize: 16, color: C.mid, padding: '4px 0' }}
              onClick={() => {}}
            >
              View all Workflows &rsaquo;
            </button>
          )}
        </div>
        ...
        {showEmpty ? (
          <EmptyWorkflowsPanel
            ...
            onNewWorkflow={onNavigateToWorkspace}
          />
        ) : (
