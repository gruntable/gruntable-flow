...
export default function TablePanel({ tables, activeTable, onChangeActive, onChangeTable }) {
  ...
  console.log('[TablePanel] Tables available:', names, '| Active:', current, '| Total tables:', names.length);
