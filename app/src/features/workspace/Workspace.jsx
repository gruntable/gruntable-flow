...
export default function Workspace() {
  ...
  }, [qc.qcTableData, orch.qcTableName, accumulatedTables]);
  ...
  const nodeCanRun = (node) => {
    if (node.behavior === "file_export" || node.behavior === "export") return true;
    if (node.node_type === "ai_transformation") return !!(nodePrompts[node.id]?.trim());
    return true;
  };
