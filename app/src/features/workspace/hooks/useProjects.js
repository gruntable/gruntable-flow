...
export default function useProjects() {
  ...
  const addProject = (onCreated) => {
    const project = createProject(nextProjectName());
    triggerSave();
  ...
  const addNode = (catalogNode, insertAfterIdx = null) => {
    ...
    const defaultTableName = catalogNode.behavior !== "file_export" && catalogNode.behavior !== "export"
    ...
    const newNode = {
      ...
      n8n_form_url: catalogNode.n8n_form_url,
      ...
      tableOutput: catalogNode.behavior !== "file_export" && catalogNode.behavior !== "export"
