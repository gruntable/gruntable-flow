...
export default function usePauseReviewTable({ pauseReviewTableName, tableRefreshKey }) {
  ...
  useEffect(() => {
    ...
    console.log(`[WF-DEBUG] table fetch effect FIRED → pauseReviewTableName=${pauseReviewTableName}, tableRefreshKey=${tableRefreshKey}, retryCount=${pauseReviewRetryCount}`);
