...
export default function WorkflowCard({ name, lastRun, onClick, onRename, onDelete }) {
  ...
  function saveRename() {
    ...
    else setNameValue(name); // revert if empty
  }
  ...
  return (
    ...
    >
      ...
      {renaming ? (
        ...
        <div style={{
          fontSize: 14, fontWeight: 600, color: C.black,
